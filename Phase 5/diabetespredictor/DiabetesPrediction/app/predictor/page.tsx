...
import { XPred, XPredResult } from "@/components/XPred";
import Results from "@/components/results";
import { orderXPredObject } from "@/components/XPred";
...
export default function Predictor() {
  ...
  const [Agedropdown, setAgeDropdown] = React.useState(new Set(["Age 18-24"]));
  ...
  React.useEffect(() => {
    handleGeneralHealthDropdownChange(
      generalhealthdropdown.values().next().value ?? "Excellent"
    );
    handleAgeDropdownChange(Agedropdown.values().next().value ?? "Age 18-24");
    handleEducationDropdownChange(
      educationdropdown.values().next().value ??
        "Never Attended or Only Kindergarten"
    );
    handleIncomeDropdownChange(
      incomedropdown.values().next().value ?? "Less than $10,000"
    );
  }, []);
  ...
  const onSubmit = (e: any) => {
    e.preventDefault();
    e.stopPropagation();
    const data = orderXPredObject(prediction ?? {});
        ...
        >
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              value={
                prediction?.HighBP !== undefined
                  ? String(prediction.HighBP)
                  : ""
              }
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              name="Smoker"
              value={
                prediction?.Smoker !== undefined
                  ? String(prediction.Smoker)
                  : ""
              }
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              value={
                prediction?.Stroke !== undefined
                  ? String(prediction.Stroke)
                  : ""
              }
              isRequired
              name="Stroke"
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              name="HeartDisease"
              onValueChange={(value) =>
                handleRadioChange("HeartDisease", value)
              }
              errorMessage="This field is required"
              classNames={{
                label: "max-w-xs",
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              value={
                prediction?.Fruits !== undefined
                  ? String(prediction.Fruits)
                  : ""
              }
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              onValueChange={(value) =>
                handleRadioChange("AnyHealthcare", value)
              }
              isRequired
              name="AnyHealthcare"
              errorMessage="This field is required"
          ...
          <div className="sm:col-span-2 flex flex-col">
            <RadioGroup
              ...
              label="Sex"
              value={
                prediction?.Sex !== undefined ? String(prediction.Sex) : ""
              }
          ...
          <div className="sm:col-span-2 flex flex-col">
            ...
            <Dropdown>
              ...
              >
                ...
                <DropdownItem key="Some Elementary">
                  Some Elementary
                </DropdownItem>
          ...
          <div className="sm:col-span-2 flex flex-col">
            ...
            <Dropdown>
              ...
              >
                ...
                <DropdownItem key="$10,000-$14,999">
                  $10,000-$14,999
                </DropdownItem>
                <DropdownItem key="$15,000-$19,999">
                  $15,000-$19,999
                </DropdownItem>
                <DropdownItem key="$20,000-$24,999">
                  $20,000-$24,999
                </DropdownItem>
                <DropdownItem key="$25,000-$34,999">
                  $25,000-$34,999
                </DropdownItem>
                <DropdownItem key="$35,000-$49,999">
                  $35,000-$49,999
                </DropdownItem>
                <DropdownItem key="$50,000-$74,999">
                  $50,000-$74,999
                </DropdownItem>
                <DropdownItem key="$75,000 or more">
                  $75,000 or more
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
          ...
          <div className="sm:col-span-4 md:col-span-8 flex flex-col items-center justify-center mt-4">
            <Button
              type="submit"
              variant="bordered"
              className="w-full justify-self-center bg-gradient-to-r dark:from-pink-800 dark:via-purple-800 dark:to-blue-800 text-black hover:text-white from-pink-500 via-purple-500 to-blue-500 text-white hover:from-pink-800 hover:via-purple-800 hover:to-blue-800"
            >
              Submit
            </Button>
          </div>
